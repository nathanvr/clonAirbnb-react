...
const Home = () => {
  return (
    ...
    <div className="main">
        ...
        <Swiper pagination={{dynamicBullets: true, clickable: true}} modules={[Pagination]}  className="mySwiper" speed={500}  breakpoints={{300:{slidesPerView:1},560: { slidesPerView: 2, }, 760: { slidesPerView: 3, spaceBetween:5}}}> 
            <SwiperSlide><CardXl
            src={cardxl1}
