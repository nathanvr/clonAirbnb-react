...
import {Button, Modal, useMantineTheme, Text,Accordion, LoadingOverlay,
} from '@mantine/core';
...
const DeleteFrame = () => {
    ...
    try {
        ...
        method: 'DELETE',
        baseURL: 'http://localhost:8080/users/deleteUser',
        headers: {
    ...
    <Accordion   icon={<Trash size={16}color="red" />} disableIconRotation>
        ...
        <Text size="sm" lineClamp={5}>
            Si eliminas tu cuenta, ya no podrás acceder en un futuro y todos tus anuncios y reservas se eliminaran automaticamente
        </Text>
        <Button style={{marginTop:10}} color="red" onClick={() => setOpened(true)}>
        Borrar
    </Button>
        </Accordion.Item>
    </Accordion>
